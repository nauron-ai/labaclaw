...
labaclaw skills install https://clawhub.ai/steipete/summarize

# Install using short prefix
labaclaw skills install clawhub:summarize

# Install from a zip already downloaded locally
labaclaw skills install ~/Downloads/summarize-1.0.0.zip
```
