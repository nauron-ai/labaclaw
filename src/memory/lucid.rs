...
impl LucidMemory {
    ...
    pub fn new(workspace_dir: &Path, local: SqliteMemory) -> Self {
        let lucid_cmd = std::env::var("LABACLAW_LUCID_CMD")
    ...
    pub(crate) fn new_with_command(
        ...
        let token_budget = std::env::var("LABACLAW_LUCID_BUDGET")
            .ok()
