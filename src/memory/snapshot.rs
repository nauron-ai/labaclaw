...
const SNAPSHOT_HEADER: &str = "# 🧠 LabaClaw Memory Snapshot\n\n\
    > Auto-generated by LabaClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 LabaClaw Memory Snapshot

> Auto-generated by LabaClaw.
...
I am LabaClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 LabaClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
