...
/// Map tool name aliases from various LLM providers to LabaClaw tool names.
...
/// to. This function encodes the mapping for known LabaClaw tools.
...
pub(super) fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. LabaClaw tool-call tags (<tool_call>, <toolcall>, <tool-call>)
