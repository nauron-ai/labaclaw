...
impl WhatsAppWebChannel {
    ...
    /// Return a stable event name for wa-rs event stream diagnostics.
    #[cfg(feature = "whatsapp-web")]
    fn event_kind(event: &wa_rs_core::types::events::Event) -> &'static str {
                ...
                async move {
                    ...
                    match event {
                        ...
                        Event::Disconnected(_) => {
                            tracing::warn!("WhatsApp Web disconnected from upstream");
                        }
                        ...
                        Event::Notification(node) => {
                            tracing::info!("WhatsApp Web notification node: {:?}", node);
                        }
                        ...
                        Event::OfflineSyncCompleted(done) => {
                            tracing::info!(
                                "WhatsApp Web offline sync completed count={}",
                                done.count
                            );
                        }
                        ...
                        Event::ClientOutdated(_) => {
                            tracing::error!("WhatsApp Web client is outdated");
                        }
